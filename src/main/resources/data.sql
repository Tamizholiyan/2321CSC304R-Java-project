-- Easwari Engineering College - Static Student Directory Seed Data
-- Walled Garden Identity Verification Records

INSERT IGNORE INTO student_directory (register_number, full_name, department, year_of_study) VALUES
